...
/***/ (function(module, exports, __webpack_require__) {
    ...
    riot.tag2('sample-output', '<h1>Hello again {opts.greet}</h1>', '', '', function(opts) {
});
...
/***/ (function(module, exports, __webpack_require__) {
    ...
    var riot = __webpack_require__(0)
    riot.tag2('hello-world', '<h1>Hello {opts.greet}!!!</h1> <p id="myTag"> My name is {author.name} and I\'m {author.age} {unit}s old </p>', 'hello-world h1,[data-is="hello-world"] h1{ font-size: 420%; color: blue; }', '', function(opts) {
      this.author = {
          name: 'Martin',
          age: 25
      }
